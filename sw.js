...
const CACHE_NAME = 'ivan-wochenplan-v7';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
// Strategie: sofort aus dem Cache antworten (schnell, funktioniert offline),
// im Hintergrund parallel neu laden und den Cache für das nächste Mal auffrischen.
